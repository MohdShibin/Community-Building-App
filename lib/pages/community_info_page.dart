...
class CommunityInfoPage extends StatefulWidget {
  ...
  const CommunityInfoPage({required this.communityId, required this.communityName, Key? key})
      : super(key: key);
...
class _CommunityInfoPageState extends State<CommunityInfoPage> {
  ...
  Future removeMembers(int index) async {
    ...
    await _firestore.collection('groups').doc(widget.communityId).update({
      "members": membersList,
    }).then((value) async {
      await _firestore
          .collection('users')
                ...
                onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => AddMembersPage(
                      groupChatId: widget.communityId,
